...
export default function App() {
  ...
  const [movedGame, setMovedGame] = useState(null)
  ...
  const swapConfidence = (sourceGameId, targetGameId) => {
    ...
    if (updatePick(targetGameId, { confidence: sourcePick.confidence })) setMovedGame({ id: targetGameId })
  }

  useEffect(() => {
    if (movedGame) setDragOverGameId(movedGame.id)
  }, [movedGame])
