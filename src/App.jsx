...
export default function App() {
  ...
  return <>
    ...
    <main id="top">
      ...
      {tab === 'charts' && <section><StandingsTable board={board} pool={pool} provisional={provisional} onProvisional={setProvisional} /><div className="charts"><CumulativePointsChart history={chartHistory} />{games.length > 0 && <CurrentWeekChart current={current} />}<WeeklyPointsChart history={chartHistory} /><GotwChart history={chartHistory} /></div></section>}
