...
select 'preseason-hof','Hall of Fame Game','preseason',2026,1,1,false,false
union all select 'preseason-'||lpad(week::text,2,'0'),'Preseason '||week,'preseason',2026,1,week+1,false,week<=2 from generate_series(1,3) week
