...
describe('four-user application flow', () => {
  ...
  it('renders all five accessible charts and every display mode', async () => {
    ...
    expect([...document.querySelectorAll('.chart-card h3')].map((heading) => heading.textContent)).toEqual(['Points vs season leader', 'Aggressiveness index', 'Current week', 'Points per week', 'Game of the Week'])
    ...
    expect(screen.getByRole('img', { name: /Aggressiveness index versus predictor/ })).toBeInTheDocument()
